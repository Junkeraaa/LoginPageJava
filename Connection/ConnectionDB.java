...
public class ConnectionDB { // criation of class ConnectionDB.
    ...
    private static final String url = "jdbc:mysql://localhost:3306/TasksListDB"; // url of used database.
    private static final String user = "root";  // user of the database.
    private static final String password = "lucas";  // password of database.
